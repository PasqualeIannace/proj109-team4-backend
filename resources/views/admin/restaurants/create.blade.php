...
<div class="container-sm">
    ...
    <div class="row">
        <div class="col-6 offset-3">
            <div class="mb-3">
                <label for="user_id" class="form-label">tuo id</label>
                <input type="user_id" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id" value="{{ old('user_id')}} ">
            @error('user_id')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>

...
<div class="container-sm d-flex flex-wrap p-5">
    ...
    <div class="bg-dark bg-opacity-50 text-light flip-card">
        ...
        {{-- BUTTON1 --}}
        {{-- <button type="submit" onclick="confirmDelete()" class="btn btn-outline-danger"
            id="confirmDeleteBtn">Elimina</button> --}}
        {{-- BUTTON2 MODAL --}}
        ...
        {{-- BUTTON3 ALERT --}}
        {{-- <button type="submit" onclick="return confirm('Sei sicuro di voler eliminare questo elemento?')"
            class="btn btn-outline-danger" id="sure">Elimina</button> --}}

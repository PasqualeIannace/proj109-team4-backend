...
@section('content')
    ...
    <div class="container-sm mt-4 bg-opacity-50 bg-black text-light">
                ...
                <div class="row mt-4">
                    ...
                    <div class="row mt-4">
                        ...
                        <input type="text" class="form-control @error('image_url') is-invalid @enderror" id="image_url"
                            name="image_url" value="{{ old('image_url', $editFood->image ?? '') }}">
                        @error('image_url')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div> --}}
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3"
                            name="description">{{ old('description') ?? $editFood->description }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="d-flex justify-content-center mt-5 mb-5">
            <button type="submit" class="btn btn-primary mb-4">Modifica</button>
        </div>
        </form>
    </div>

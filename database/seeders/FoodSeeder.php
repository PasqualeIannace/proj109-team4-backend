...
class FoodSeeder extends Seeder
{
    ...
    public function run()
    {
        $foods = [
            ...
            [
                'image' => 'https://www.cookshideout.com/wp-content/uploads/2016/09/Veg-Bhel_FI-500x375.jpg',
                'name' => 'Bhelpuri',
            ...
            [
                ...
                'name' => 'Biryani',
                'ingredients' => 'pollo, yogurt bianco, succo di limone, curry, curcuma, aglio, cipolla',
                'description' => 'Il biryani è una preparazione molto diffusa in India e in tutta Asia meridionale ed è una pietanza affascinante per i sapori e i profumi che racchiude. Il biryani di pollo che vi proponiamo è una ricetta che prevede carne, riso basmati, yogurt e spezie..',
                'price' => '12€',
                'visible' => true,
                'user_id' => 1,
            ],
            [
                'image' => 'https://falasteenifoodie.com/wp-content/uploads/2023/03/DSC08605-scaled.jpg',
                'name' => 'Tandoori Chicken',
                'ingredients' => 'pollo, Pasta di aglio e zenzero, Pasta tandoori, curry, curcuma, aglio, Sale fino',
                'description' => 'Nato per caso, dopo un esperimento di un ristoratore di Peshawar, il pollo tandoori è diventato uno dei piatti principali della cucina indiana..',
                'price' => '15€',
                'visible' => true,
                'user_id' => 1,
            ],

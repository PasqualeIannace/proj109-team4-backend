                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.restaurants.edit' ? 'bg-secondary' : '' }}"
                                    href="{{route('admin.restaurants.edit')}}">
                                    <i class="fa-solid fa-wand-magic-sparkles"></i> Modifica Piatto
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.restaurants.show' ? 'bg-secondary' : '' }}"
                                    href="{{route('admin.restaurants.show')}}">
                                    <i class="fa-solid fa-info"></i> Dettagli Piatto
                                </a>
                            </li>
